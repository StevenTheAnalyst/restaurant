import '../menu_version_mobile_screen/widgets/listkisspngitalian_item_widget.dart';
...
class MenuVersionMobileScreen extends GetWidget<MenuVersionMobileController> {
  @override
                              ...
                              child: Obx(
                                () => ListView.builder(
                                  ...
                                  itemCount: controller
                                      .menuVersionMobileModelObj
                                      .value
                                      .listkisspngitalianItemList
                                      .length,
                                  itemBuilder: (context, index) {
                                    ListkisspngitalianItemModel model =
                                        controller
                                            .menuVersionMobileModelObj
                                            .value
                                            .listkisspngitalianItemList[index];
